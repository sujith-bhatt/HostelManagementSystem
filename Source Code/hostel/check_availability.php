...
if($count>0)
{
echo "<span style='color:red'> Entered Email Id already exists!</span>";
}
else{
	echo "<span style='color:green'> Entered Email is available for registration!</span>";
}
}
}
...
$stmt->close();
if($count>0)
echo "<span style='color:red'>$count. The room is already filled!!.</span>";
else
